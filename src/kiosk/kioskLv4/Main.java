...
public class Main {
    public static void main(String[] args) {
        ...
        burgers.menuItemList.add(shackBurger);
        burgers.menuItemList.add(smokeShack);
        burgers.menuItemList.add(cheeseburger);
        burgers.menuItemList.add(hamburger);
        ...
        drinks.menuItemList.add(coke);
        drinks.menuItemList.add(iceAmericano);
        drinks.menuItemList.add(icedTea);
        drinks.menuItemList.add(latte);
        drinks.menuItemList.add(sprite);
        ...
        desserts.menuItemList.add(cheeseStick);
        desserts.menuItemList.add(iceCream);
        desserts.menuItemList.add(bingSu);
